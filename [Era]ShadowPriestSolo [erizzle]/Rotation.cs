...
public class EraShadowPriest : Rotation
{
    ...
    public override bool PassivePulse()
    {
        ...
        if (Api.Spellbook.CanCast("Renew") && !me.Auras.Contains("Renew",false) && healthPercentage < 80)
        {
        ...
        if (Api.Spellbook.CanCast("Shadow Protection") && !me.Auras.Contains("Shadow Protection", false))
        {
            Console.ForegroundColor = ConsoleColor.Green;
